...
const EmpCard = ({data,onClick}) => {
  return (
    <div className='flex justify-center items-center mt-3'>
          <div className='flex justify-evenly items-center w-[23rem] h-[5rem] bg-[#d8d8cfab] rounded-full cursor-pointer hover:scale-y-105'onClick={onClick}>
